...
function getExample(tag) {
  const examples = {
    ...
    author_description: 'Senior Developer at teil1',
    author_avatar_url: 'https://secure.gravatar.com/avatar/…',
    site_name: 'teil1',
    site_url: 'https://teil1.de/',
    site_description: 'Performance Marketing Agency',
    site_logo: 'https://teil1.de/wp-content/uploads/logo.svg',
    site_language: 'de-DE',
